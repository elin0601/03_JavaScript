...
// #test1-2 버튼 클릭 시 #test1-1의 onclick 이벤트 리스너의 이벤트 핸들러 제거하기
...
test2.addEventListener("click", function(){
    ...
    /* 표쥰 이벤트 모델의 이벤트 핸들러 안에서 this == 이벤트가 발생한 요소 */
    this.innerText = count; // 증가한 count값을 test2 내용을 대입
});
...
/* #input3에서 Enter 입력*key 관련 이벤트) 시 배경색 배경 */
