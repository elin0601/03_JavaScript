...
btn2.addEventListener("click", ()=>{
    ...
    // 메서드(갹체의 기능(함수)) 추가
    smartPhone.imformation = function (){
        ...
        */
        ...
        console.log("브랜드 : ", brand); // 지역변수
    }

    // 메서드 수행
    smartPhone.imformation(); 
...
btn3.addEventListener("click", ()=> {
    ...
    const student2 = new Student("김철수", 4, 6, 3, 90);
    ...
    studentList.push(new Student("이영희", 2, 7, 4, 100));
    studentList.push(new Student("신짱구", 1, 3, 15, 30));
