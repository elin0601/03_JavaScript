...
/* 변수에 대입한 값 변경하기 */
number1 = 300; //number1에 300 대입(기존 값 10을 덮어쓰기 함)
number2 = 400; 
...
// ---------------------------------------------
// 3. const (상수, constant, 항[상] 같은 [수], 고정된 값)
...
const phone = '010-1234-1234';  //홑따옴표
...
// 값을 K:V (Map) 형식으로 여러개 저장하는 형태 -> { K:V, K:V, K:V }
 
// K(key)   : 값을 구분하는 이름
// V(vlaue) : K에 대응되는 값(변수에 대입되는 값)
