...
function check1() {
    ...
    arr2[1] = "눈온다";
    arr2[2] = true;
    // (JS 배열의 특장 : 인덱스 별로 자료형을 다르게 할 수 있다)
...
function check3() {
    ...
    /* 배열의 index는 0부터 배열길이 -1 까지 1씩 증가 */
...
function orderFn() {
    ...
    while(true) {
        ...
        if (selectMenu == null) break;  // 메뉴명 입력 시 취소를 클릭 한 경우
        
        /* 입력 한 메뉴가 menus 몇번째 인덱스에 존재하는가 */
        // -> 배열 검색
