...
const sum1 = document.getElementById("num1");
const sum2 = document.getElementById("num2");
const sum3 = document.getElementById("num3");
const total= document.getElementById("total");

function sumFn(){
    const value1 = Number(sum1.value);
    const value2 = Number(sum2.value);
    const value3 = Number(sum3.value);
...
function check1() {
    ...
    // -> 다른 연산보다 먼저 수행
    // -> count 값이 먼저 증가, 감소 된 후 console에 출력된다
